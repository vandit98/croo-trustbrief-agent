...
9. Use `outputs/dorahacks_demo_package.md` for the recording sequence, screenshot checklist, source/hash block, A2A buyer proof, live-commerce evidence manifest, and manual live-proof slot.
