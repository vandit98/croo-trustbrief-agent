...
- DoraHacks-ready demo material is generated by `trustbrief_agent/submission_package.py`, which turns the judge bundle into BUIDL copy, a 5-minute runbook, screenshot checklist, judge demo capture plan, source/hash block, and a credentialed live-proof slot without performing authenticated submission or wallet actions.
