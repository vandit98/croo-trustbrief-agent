...
7. Open `outputs/demo_report.json`, `outputs/mock_cap_demo.json`, `outputs/requester_demo.json`, `outputs/buyer_composability_demo.json`, `outputs/live_commerce_evidence.json`, `outputs/agent_store_listing_kit.json`, `outputs/judge_bundle.json`, and `outputs/dorahacks_demo_package.md`.
...
10. Use `outputs/dorahacks_demo_package.md` for the recording sequence, screenshot checklist, judge demo capture plan, Agent Store listing kit, source/hash block, A2A buyer proof, live-commerce evidence manifest, and manual live-proof slot.
